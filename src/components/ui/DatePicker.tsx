...
export const DatePicker = forwardRef<HTMLInputElement, DatePickerProps>(
  (
    ...
    const baseClasses = 'block px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-0 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed bg-white text-gray-900';
